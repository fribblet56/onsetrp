...
AddEvent("OnTranslationReady", function()
        -- POLICE MENU
        policeMenu = Dialog.create(_("police_menu"), nil, "Menotter / Démenotter ", _("put_player_in_vehicle"), _("remove_player_from_vehicle"), _("give_player_fine"), _("callouts"), "Fouiller le Joueur", "Détecteur de Printer",_("cancel"))
